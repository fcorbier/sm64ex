...
const SDL_Scancode windows_scancode_table[] = {
  ...
  SDL_SCANCODE_UNKNOWN,        SDL_SCANCODE_RETURN,         SDL_SCANCODE_CAPSLOCK,    SDL_SCANCODE_F1,             SDL_SCANCODE_F2,      SDL_SCANCODE_F3,             SDL_SCANCODE_F4,             SDL_SCANCODE_F5,         /* 3 */
  ...
  SDL_SCANCODE_UNKNOWN,        SDL_SCANCODE_PAGEUP,         SDL_SCANCODE_KP_MINUS,    SDL_SCANCODE_UNKNOWN,        SDL_SCANCODE_KP_5,    SDL_SCANCODE_UNKNOWN,        SDL_SCANCODE_KP_PLUS,        SDL_SCANCODE_END,        /* 4 */

  SDL_SCANCODE_UNKNOWN,        SDL_SCANCODE_PAGEDOWN,       SDL_SCANCODE_INSERT,      SDL_SCANCODE_DELETE,         SDL_SCANCODE_UNKNOWN, SDL_SCANCODE_UNKNOWN,        SDL_SCANCODE_NONUSBACKSLASH, SDL_SCANCODE_F11,        /* 5 */
...
static void gfx_sdl_init(const char *window_title) {
    ...
    inverted_scancode_table[SDL_SCANCODE_LEFT] = 0x14B;
    inverted_scancode_table[SDL_SCANCODE_RIGHT] = 0x14D;
}
